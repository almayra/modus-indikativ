...
var BodyShort = function (_a) {
    ...
    return (_jsx("div", __assign({ style: __assign({ color: color }, style), className: "typography body-short-" + variant + " " + (bold ? "bold" : "") + " " + className }, { children: children }), void 0));
};
